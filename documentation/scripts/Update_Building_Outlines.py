...
***** Important note! *****  
This script assumes that all and any necessary manual edits have already been performed and the script is supposed to work on a shapefile that reflects all those manual edits.
...
seattle_buildings_path = rf"{root_shp_path}\seattle_building_outlines_2023_updated.shp"
